...
public class ViewSearchMovie {
	...
	public ViewSearchMovie() {
		initialize();
		initialize();
		initComponent(); //Centraliza tela
		this.currentMonth = 1;
		this.currentYear = 2019;
	}
	
	public static tableModel getTblModel() {
		return tblModel;
	}
	...
	public void initComponent() {
		this.frmSearch.setLocationRelativeTo(null);
	}
	...
	private void initialize() {
		...
		frmSearch.getContentPane().add(btnRegister);
		...
		btnClean.setBounds(479, 132, 102, 30);
		frmSearch.getContentPane().add(btnClean);
		
		// table
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setViewportBorder(new LineBorder(Color.LIGHT_GRAY));
		scrollPane.setBounds(21, 174, 674, 195);
